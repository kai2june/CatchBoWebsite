...
class ContractManager {
    ...
    deploy(orderId, merchandiseName, description, price, sellerName, sellerCoinbase, buyerName, buyerCoinbase, locker, callback) {
        ...
        c.new(orderId, merchandiseName, description, this.web3.toWei(price, "ether"), sellerName, sellerCoinbase, buyerName, buyerCoinbase, locker,
            {
                from: sellerCoinbase,
